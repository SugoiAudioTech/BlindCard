...
void LocalizationManager::initializeStrings()
{
    ...
    stringsEn[StringKey::UpdatePage] = "Update Page";
    stringsEn[StringKey::ManualPage] = "User Manual";
    ...
    stringsEn[StringKey::GuideStep5Full] = "Click \"NEXT ROUND\" to continue, or \"REVEAL\" on the final round to see results";
    ...
    stringsEn[StringKey::GuideTipText3] = "\"Crossfade\" controls the card transition time (1-100 ms).";
    stringsEn[StringKey::GuideTipText4] = "Lower = faster switching, higher = smoother, click-free transitions.";
    stringsEn[StringKey::GuideTipText5] = "Set \"Rounds\" (1-8) to perform multiple blind tests.";
    stringsEn[StringKey::GuideTipText6] = "Results are averaged across rounds for more reliable comparisons.";
    ...
    stringsZhTw[StringKey::UpdatePage] = juce::CharPointer_UTF8("\xe6\x9b\xb4\xe6\x96\xb0\xe9\xa0\x81\xe9\x9d\xa2");  // 更新頁面
    stringsZhTw[StringKey::ManualPage] = juce::CharPointer_UTF8("\xe4\xbd\xbf\xe7\x94\xa8\xe6\x89\x8b\xe5\x86\x8a");  // 使用手冊
    ...
    stringsZhTw[StringKey::GuideStep5Full] = juce::CharPointer_UTF8("");  // 點擊「下一輪」繼續，或在最後一輪點擊「開牌」查看結果
    ...
    stringsZhTw[StringKey::GuideTipText3] = juce::CharPointer_UTF8("");  // 調整「Crossfade」設定切換卡片時的過渡時間（1-100 毫秒）。
    stringsZhTw[StringKey::GuideTipText4] = juce::CharPointer_UTF8("");  // 數值越短切換越快，數值越長過渡越平滑，避免爆音。
    stringsZhTw[StringKey::GuideTipText5] = juce::CharPointer_UTF8("\xe8\xa8\xad\xe5\xae\x9a\xe3\x80\x8c\xe5\x9b\x9e\xe5\x90\x88\xe3\x80\x8d\x28\x31\x2d\x38\x29\x20\xe9\x80\xb2\xe8\xa1\x8c\xe5\xa4\x9a\xe8\xbc\xaa\xe6\xb8\xac\xe8\xa9\xa6\xe3\x80\x82");  // 設定「回合」(1-8) 進行多輪測試。
    stringsZhTw[StringKey::GuideTipText6] = juce::CharPointer_UTF8("\xe7\xb5\x90\xe6\x9e\x9c\xe6\x9c\x83\xe8\xb7\xa8\xe5\x9b\x9e\xe5\x90\x88\xe5\xb9\xb3\xe5\x9d\x87\xe8\xa8\x88\xe7\xae\x97\xef\xbc\x8c\xe7\xa2\xba\xe4\xbf\x9d\xe6\x9b\xb4\xe5\x8f\xaf\xe9\x9d\xa0\xe7\x9a\x84\xe6\xaf\x94\xe8\xbc\x83\xe3\x80\x82");  // 結果會跨回合平均計算，確保更可靠的比較。
    ...
    stringsJa[StringKey::UpdatePage] = juce::CharPointer_UTF8("\xe3\x82\xa2\xe3\x83\x83\xe3\x83\x97\xe3\x83\x87\xe3\x83\xbc\xe3\x83\x88\xe3\x83\x9a\xe3\x83\xbc\xe3\x82\xb8");  // アップデートページ
    stringsJa[StringKey::ManualPage] = juce::CharPointer_UTF8("\xe3\x83\x9e\xe3\x83\x8b\xe3\x83\xa5\xe3\x82\xa2\xe3\x83\xab");  // マニュアル
    ...
    stringsJa[StringKey::GuideStep5Full] = juce::CharPointer_UTF8("");  // 「次のラウンド」で続行、最終ラウンドで「公開」をクリックして結果を確認
    ...
    stringsJa[StringKey::GuideTipText3] = juce::CharPointer_UTF8("");  // 「Crossfade」でカード切り替え時のトランジション時間を調整（1-100 ms）。
    stringsJa[StringKey::GuideTipText4] = juce::CharPointer_UTF8("");  // 値が小さいほど素早く、大きいほど滑らかでクリックノイズのない遷移になります。
    stringsJa[StringKey::GuideTipText5] = juce::CharPointer_UTF8("\xe3\x80\x8c\xe3\x83\xa9\xe3\x82\xa6\xe3\x83\xb3\xe3\x83\x89\xe3\x80\x8d\x28\x31\x2d\x38\x29\x20\xe3\x81\xa7\xe8\xa4\x87\xe6\x95\xb0\xe5\x9b\x9e\xe3\x83\x86\xe3\x82\xb9\xe3\x83\x88\xe3\x82\x92\xe8\xa1\x8c\xe3\x81\x84\xe3\x81\xbe\xe3\x81\x99\xe3\x80\x82");  // 「ラウンド」(1-8) で複数回テストを行います。
    stringsJa[StringKey::GuideTipText6] = juce::CharPointer_UTF8("");  // 結果はラウンド全体で平均化され、より信頼性の高い比較ができます。
    ...
    stringsZhCn[StringKey::UpdatePage] = juce::CharPointer_UTF8("\xe6\x9b\xb4\xe6\x96\xb0\xe9\xa1\xb5\xe9\x9d\xa2");  // 更新页面
    stringsZhCn[StringKey::ManualPage] = juce::CharPointer_UTF8("\xe4\xbd\xbf\xe7\x94\xa8\xe6\x89\x8b\xe5\x86\x8c");  // 使用手册
    ...
    stringsZhCn[StringKey::GuideStep5Full] = juce::CharPointer_UTF8("");  // 点击「下一轮」继续，或在最后一轮点击「揭示」查看结果
    ...
    stringsZhCn[StringKey::GuideTipText3] = juce::CharPointer_UTF8("");  // 调整「Crossfade」设定切换卡片时的过渡时间（1-100 毫秒）。
    stringsZhCn[StringKey::GuideTipText4] = juce::CharPointer_UTF8("");  // 数值越短切换越快，数值越长过渡越平滑，避免爆音。
    stringsZhCn[StringKey::GuideTipText5] = juce::CharPointer_UTF8("\xe8\xae\xbe\xe5\xae\x9a\xe3\x80\x8c\xe5\x9b\x9e\xe5\x90\x88\xe3\x80\x8d\x28\x31\x2d\x38\x29\x20\xe8\xbf\x9b\xe8\xa1\x8c\xe5\xa4\x9a\xe8\xbd\xae\xe6\xb5\x8b\xe8\xaf\x95\xe3\x80\x82");  // 设定「回合」(1-8) 进行多轮测试。
    stringsZhCn[StringKey::GuideTipText6] = juce::CharPointer_UTF8("\xe7\xbb\x93\xe6\x9e\x9c\xe4\xbc\x9a\xe8\xb7\xa8\xe5\x9b\x9e\xe5\x90\x88\xe5\xb9\xb3\xe5\x9d\x87\xe8\xae\xa1\xe7\xae\x97\xef\xbc\x8c\xe7\xa1\xae\xe4\xbf\x9d\xe6\x9b\xb4\xe5\x8f\xaf\xe9\x9d\xa0\xe7\x9a\x84\xe6\xaf\x94\xe8\xbe\x83\xe3\x80\x82");  // 结果会跨回合平均计算，确保更可靠的比较。
    ...
    stringsKo[StringKey::UpdatePage] = juce::CharPointer_UTF8("\xec\x97\x85\xeb\x8d\xb0\xec\x9d\xb4\xed\x8a\xb8\x20\xed\x8e\x98\xec\x9d\xb4\xec\xa7\x80");  // 업데이트 페이지
    stringsKo[StringKey::ManualPage] = juce::CharPointer_UTF8("\xeb\xa7\xa4\xeb\x89\xb4\xec\x96\xbc");  // 매뉴얼
    ...
    stringsKo[StringKey::GuideStep5Full] = juce::CharPointer_UTF8("\"\xeb\x8b\xa4\xec\x9d\x8c \xeb\x9d\xbc\xec\x9a\xb4\xeb\x93\x9c\"\xeb\xa1\x9c \xea\xb3\x84\xec\x86\x8d\xed\x95\x98\xea\xb1\xb0\xeb\x82\x98, \xeb\xa7\x88\xec\xa7\x80\xeb\xa7\x89 \xeb\x9d\xbc\xec\x9a\xb4\xeb\x93\x9c\xec\x97\x90\xec\x84\x9c \"\xea\xb3\xb5\xea\xb0\x9c\"\xeb\xa5\xbc \xed\x81\xb4\xeb\xa6\xad\xed\x95\x98\xec\x97\xac \xea\xb2\xb0\xea\xb3\xbc\xeb\xa5\xbc \xed\x99\x95\xec\x9d\xb8");  // "다음 라운드"로 계속하거나, 마지막 라운드에서 "공개"를 클릭하여 결과를 확인
    ...
    stringsKo[StringKey::GuideTipText3] = juce::CharPointer_UTF8("");  // "Crossfade"로 카드 전환 시 트랜지션 시간을 조절합니다 (1-100 ms).
    stringsKo[StringKey::GuideTipText4] = juce::CharPointer_UTF8("");  // 값이 작을수록 빠르게 전환되고, 클수록 부드럽고 클릭 노이즈 없는 전환이 됩니다.
    stringsKo[StringKey::GuideTipText5] = juce::CharPointer_UTF8("\x22\xeb\x9d\xbc\xec\x9a\xb4\xeb\x93\x9c\x22\x20\x28\x31\x2d\x38\x29\xeb\xa1\x9c\x20\xec\x97\xac\xeb\x9f\xac\x20\xeb\xb2\x88\x20\xed\x85\x8c\xec\x8a\xa4\xed\x8a\xb8\xeb\xa5\xbc\x20\xec\xa7\x84\xed\x96\x89\xed\x95\xa9\xeb\x8b\x88\xeb\x8b\xa4\x2e");  // "라운드" (1-8)로 여러 번 테스트를 진행합니다.
    stringsKo[StringKey::GuideTipText6] = juce::CharPointer_UTF8("");  // 결과는 라운드 전체에서 평균화되어 더 신뢰할 수 있는 비교가 가능합니다.
    ...
    // Header Bar
    stringsEs[StringKey::NowPlaying] = "Reproduciendo:";
    stringsEs[StringKey::NoFileLoaded] = juce::CharPointer_UTF8("Ning\xc3\xban archivo cargado");  // Ningún archivo cargado

    // Mode Selector
    stringsEs[StringKey::ModeStars] = "Estrellas";
    stringsEs[StringKey::ModeGuess] = "Adivinar";
    stringsEs[StringKey::ModeQA] = "P&R";

    // Control Panel - Buttons
    stringsEs[StringKey::ButtonShuffle] = "MEZCLAR";
    stringsEs[StringKey::ButtonReveal] = "REVELAR";
    stringsEs[StringKey::ButtonReset] = "REINICIAR";
    stringsEs[StringKey::ButtonNextRound] = "SIGUIENTE RONDA";
    stringsEs[StringKey::ButtonSubmit] = "ENVIAR";

    // Control Panel - Labels
    stringsEs[StringKey::LabelRounds] = "Rondas";
    stringsEs[StringKey::LabelAutoGain] = "Auto Gain";
    stringsEs[StringKey::LabelQuestions] = "Preguntas";
    stringsEs[StringKey::LabelCards] = "Tarjetas";

    // Control Panel - Status
    stringsEs[StringKey::StatusReady] = "Listo";
    stringsEs[StringKey::StatusShuffled] = "Mezclado";
    stringsEs[StringKey::StatusRevealed] = "Revelado";
    stringsEs[StringKey::StatusRound] = "Ronda";
    stringsEs[StringKey::StatusOf] = "de";
    stringsEs[StringKey::StatusDetecting] = "Detectando...";
    stringsEs[StringKey::StatusWaiting] = "Esperando...";

    // Results Panel
    stringsEs[StringKey::ResultsTitle] = "Resultados";
    stringsEs[StringKey::ResultsEmpty] = juce::CharPointer_UTF8("Sin resultados a\xc3\xban");  // Sin resultados aún
    stringsEs[StringKey::ResultsTrack] = "Pista";
    stringsEs[StringKey::ResultsScore] = juce::CharPointer_UTF8("Puntuaci\xc3\xb3n");  // Puntuación
    stringsEs[StringKey::ResultsAverage] = "Promedio";
    stringsEs[StringKey::ResultsCorrect] = "Correcto";
    stringsEs[StringKey::ResultsIncorrect] = "Incorrecto";
    stringsEs[StringKey::ResultsTotal] = "Total";
    stringsEs[StringKey::ResultsCurrentRound] = "RONDA ACTUAL";
    stringsEs[StringKey::ResultsFinalResults] = "RESULTADOS FINALES";
    stringsEs[StringKey::ResultsAnswerQuestions] = "Responde preguntas para ver resultados";

    // Question Banner (Q&A mode)
    stringsEs[StringKey::QAQuestion] = "Pregunta";
    stringsEs[StringKey::QASelectCard] = "Selecciona una tarjeta";
    stringsEs[StringKey::QAWhichBetter] = juce::CharPointer_UTF8("\xc2\xbf" "Cu\xc3\xa1l suena mejor?");  // ¿Cuál suena mejor?
    stringsEs[StringKey::QAPreference] = "Tu preferencia";
    stringsEs[StringKey::QAWhichCardIs] = juce::CharPointer_UTF8("\xc2\xbf" "Qu\xc3\xa9 tarjeta es ");  // ¿Qué tarjeta es
    stringsEs[StringKey::QAWhichOneIs] = juce::CharPointer_UTF8("\xc2\xbf" "Cu\xc3\xa1l es ");  // ¿Cuál es
    stringsEs[StringKey::QARemaining] = "restantes";
    stringsEs[StringKey::QAQuestionProgress] = "Pregunta";
    stringsEs[StringKey::QAAnswer] = "Respuesta: ";
    stringsEs[StringKey::QAScoreLabel] = juce::CharPointer_UTF8("Puntuaci\xc3\xb3n: ");  // Puntuación:
    stringsEs[StringKey::QAPressResetToPlayAgain] = "Presiona Reiniciar para jugar de nuevo";

    // Poker Card
    stringsEs[StringKey::CardDropHere] = juce::CharPointer_UTF8("Suelta el archivo de audio aqu\xc3\xad");  // Suelta el archivo de audio aquí
    stringsEs[StringKey::CardDragFile] = juce::CharPointer_UTF8("Arrastra audio aqu\xc3\xad");  // Arrastra audio aquí
    stringsEs[StringKey::CardTrack] = "Pista";
    stringsEs[StringKey::CardSelect] = "Seleccionar";

    // Card Count Control
    stringsEs[StringKey::CardCountLabel] = juce::CharPointer_UTF8("N\xc3\xbamero de Tarjetas");  // Número de Tarjetas

    // Settings Panel
    stringsEs[StringKey::SettingsTitle] = juce::CharPointer_UTF8("Configuraci\xc3\xb3n");  // Configuración
    stringsEs[StringKey::SettingsLanguage] = "Idioma";
    stringsEs[StringKey::SettingsTheme] = "Tema";
    stringsEs[StringKey::SettingsThemeLight] = "Claro";
    stringsEs[StringKey::SettingsThemeDark] = "Oscuro";
    stringsEs[StringKey::SettingsClose] = "Cerrar";

    // About Dialog
    stringsEs[StringKey::AboutTitle] = "Acerca de";
    stringsEs[StringKey::AboutFreeSoftware] = "Es Software Libre";
    stringsEs[StringKey::AboutNoLicense] = "No requiere clave de licencia";
    stringsEs[StringKey::AboutVersion] = juce::CharPointer_UTF8("Versi\xc3\xb3n:");  // Versión:
    stringsEs[StringKey::AboutDeveloper] = "Desarrollador:";
    stringsEs[StringKey::AboutVisitWebsite] = "Visitar Sitio Web Oficial";

    // Update Checker
    stringsEs[StringKey::UpdateAvailable] = juce::CharPointer_UTF8("Nueva versi\xc3\xb3n disponible:");  // Nueva versión disponible:
    stringsEs[StringKey::UpdateUpToDate] = "Actualizado";
    stringsEs[StringKey::UpdateDownload] = "Descargar";
    stringsEs[StringKey::UpdatePage] = juce::CharPointer_UTF8("P\xc3\xa1gina de Actualizaci\xc3\xb3n");  // Página de Actualización
    stringsEs[StringKey::ManualPage] = "Manual de Usuario";

    // Quick Start Guide
    stringsEs[StringKey::GuideTitle] = juce::CharPointer_UTF8("Gu\xc3\xad" "a de Inicio R\xc3\xa1pido");  // Guía de Inicio Rápido
    stringsEs[StringKey::GuideGotIt] = juce::CharPointer_UTF8("\xc2\xa1" "Entendido!");  // ¡Entendido!
    stringsEs[StringKey::GuideDescription] = juce::CharPointer_UTF8("Blind Card te permite comparar pistas de audio sin saber cu\xc3\xa1l es cu\xc3\xa1l, eliminando sesgos de tus decisiones.");  // cuál es cuál

    // Steps (full detailed text)
    stringsEs[StringKey::GuideStep1Full] = "Inserta Blind Card en cada pista que quieras comparar (2-8 pistas)";
    stringsEs[StringKey::GuideStep2Intro] = juce::CharPointer_UTF8("Elige un modo de evaluaci\xc3\xb3n:");  // evaluación
    stringsEs[StringKey::GuideStep3Full] = "Haz clic en \"MEZCLAR\" para aleatorizar y ocultar las identidades";
    stringsEs[StringKey::GuideStep4Full] = juce::CharPointer_UTF8("Haz clic en las tarjetas para escuchar y evaluar (o usa teclas de direcci\xc3\xb3n)");  // dirección
    stringsEs[StringKey::GuideStep5Full] = juce::CharPointer_UTF8("Haz clic en \"SIGUIENTE RONDA\" para continuar, o \"REVELAR\" en la \xc3\xba" "ltima ronda");  // última
    stringsEs[StringKey::GuideStep6Full] = "Haz clic en \"REINICIAR\" para comenzar una nueva prueba";

    // Mode descriptions in guide
    stringsEs[StringKey::GuideModeStarsDesc] = juce::CharPointer_UTF8("Eval\xc3\xba" "a cada pista de 1 a 5 estrellas");  // Evalúa
    stringsEs[StringKey::GuideModeGuessDesc] = juce::CharPointer_UTF8("Identifica qu\xc3\xa9 plugin/mezcla est\xc3\xa1 en cada tarjeta");  // qué, está
    stringsEs[StringKey::GuideModeQADesc] = juce::CharPointer_UTF8("Encuentra una pista espec\xc3\xad" "fica cuando se te indique");  // específica

    // Tip box
    stringsEs[StringKey::GuideTip] = "Consejo";
    stringsEs[StringKey::GuideTipText1] = "Activa \"Auto Gain\" para igualar el volumen de todas las pistas,";
    stringsEs[StringKey::GuideTipText2] = juce::CharPointer_UTF8("asegurando una comparaci\xc3\xb3n justa sin sesgo de volumen.");  // comparación
    stringsEs[StringKey::GuideTipText3] = juce::CharPointer_UTF8("\"Crossfade\" controla el tiempo de transici\xc3\xb3n entre tarjetas (1-100 ms).");  // transición
    stringsEs[StringKey::GuideTipText4] = juce::CharPointer_UTF8("Menor = cambio m\xc3\xa1s r\xc3\xa1pido, mayor = transiciones m\xc3\xa1s suaves.");  // más rápido, más
    stringsEs[StringKey::GuideTipText5] = "Configura \"Rondas\" (1-8) para realizar varias pruebas ciegas.";
    stringsEs[StringKey::GuideTipText6] = juce::CharPointer_UTF8("Los resultados se promedian entre rondas para comparaciones m\xc3\xa1s confiables.");  // más

    // Keyboard shortcuts
    stringsEs[StringKey::GuideKeyboardShortcuts] = "Atajos de Teclado";
    stringsEs[StringKey::GuideShortcutSelectCard] = "Seleccionar tarjeta directamente";
    stringsEs[StringKey::GuideShortcutNextPrev] = "Siguiente / Anterior tarjeta";
    stringsEs[StringKey::GuideShortcutBrackets] = "Anterior / Siguiente tarjeta";
    stringsEs[StringKey::GuideShortcutArrows] = juce::CharPointer_UTF8("Navegar tarjetas (puede no funcionar en Logic Pro)");

    // Dialogs
    stringsEs[StringKey::DialogSavePreset] = juce::CharPointer_UTF8("Guardar Ajuste Predefinido");
    stringsEs[StringKey::DialogEnterName] = "Ingresa el nombre:";
    stringsEs[StringKey::DialogSave] = "Guardar";
    stringsEs[StringKey::DialogCancel] = "Cancelar";
    stringsEs[StringKey::DialogDelete] = "Eliminar";
    stringsEs[StringKey::DialogConfirmDelete] = juce::CharPointer_UTF8("\xc2\xbf" "Eliminar este ajuste?");  // ¿Eliminar este ajuste?
    stringsEs[StringKey::DialogYes] = juce::CharPointer_UTF8("S\xc3\xad");  // Sí
    stringsEs[StringKey::DialogNo] = "No";

    // Import
    stringsEs[StringKey::ImportFiles] = "Importar Archivos";
    stringsEs[StringKey::ImportSuccess] = juce::CharPointer_UTF8("Importaci\xc3\xb3n exitosa");  // Importación exitosa
    stringsEs[StringKey::ImportFailed] = juce::CharPointer_UTF8("Importaci\xc3\xb3n fallida");  // Importación fallida
    stringsEs[StringKey::ImportFilesLoaded] = "archivos cargados";

    // Transport Bar
    stringsEs[StringKey::TransportPlay] = "Reproducir";
    stringsEs[StringKey::TransportPause] = "Pausar";
    stringsEs[StringKey::TransportStop] = "Detener";

    // Presets
    stringsEs[StringKey::PresetDefault] = "Predeterminado";
    stringsEs[StringKey::PresetSave] = "Guardar";
    stringsEs[StringKey::PresetDelete] = "Eliminar";
    stringsEs[StringKey::PresetSelect] = "Seleccionar Preset";

    // Star Rating
    stringsEs[StringKey::RatingLabel] = juce::CharPointer_UTF8("Calificaci\xc3\xb3n");  // Calificación

    // Guess Dropdown
    stringsEs[StringKey::GuessSelect] = "Seleccionar pista...";
    stringsEs[StringKey::GuessNone] = "Ninguno";
}
